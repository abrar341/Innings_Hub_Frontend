...
const MatchSummary = () => {
    ...
    return (
        <div className="min-h-screen space-y-6 p-4 bg-gray-100">
            ...
            <button className='border px-4 py-2 bg-blue-500 text-white font-semibold rounded'>View Full ScoreCard</button>
        </div>
    );
};
