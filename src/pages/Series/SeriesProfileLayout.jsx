            ...
            <div className="hover:cursor-pointer transition duration-300 ease-in group border-t border-gray-300 overflow-hidden">
                <div className=" container py-3">
                    <div className="flex flex-wrap items-center">
                        <div className="p-4 flex justify-between sm:w-7/12 w-full flex flex-col sm:flex-row  items-center mb-3 sm:mb-0">
                            {/* <img
                            ...
                            {
                                tournament?.winner && (<div className='text-lg font-extrabold uppercase text-gray-700 border p-4 border-gray-400 rounded-xl'>Champion: {tournament?.winner?.teamName}</div>)
                            }
                        </div>
                    </div>
                </div>
