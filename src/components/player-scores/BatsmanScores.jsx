...
import { getBattingStats, getScore } from "../ui/utils";
import { Skeleton } from "../ui/skeleton";

function BatsmanScores({ playerIds, events, onStrikeBatsman }) {
    const player1 = "fdsf";
    const player2 = "das";

    return (
        <div className="flex  border w-full flex-col justify-between gap-1 rounded-md bg-muted p-2 text-lg">
