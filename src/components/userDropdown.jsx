...
const UserDropdown = () => {
    ...
    return (
        <div className="z-100 relative inline-block text-left" ref={dropdownRef}>
            <div
                className={`flex items-center gap-2 bg-gray-50 dark:bg-gray-800 cursor-pointer p-2 hover:bg-gray-300 dark:hover:bg-gray-700 rounded transition-all duration-300`}
            ...
            {isOpen && (
                ...
                >
                    <div className="py-1" role="none">
                        ...
                        {userInfo?.role === 'admin' || userInfo?.role === 'club-manager' ? (
                            <Link
                                to="/"
                                className="text-gray-700 dark:text-gray-300 flex items-center gap-2 w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                            >
