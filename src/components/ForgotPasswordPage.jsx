...
import { useForgotPasswordMutation } from "../slices/auth/usersApiSlice";
...
const ForgotPasswordPage = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            toast.dismiss()
            toast.error(err?.data?.message || "Error occurred while sending password reset email.");
        }
    };
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <motion.button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? <Loader className="w-6 h-6 animate-spin mx-auto" /> : "Send Reset Password"}
                        </motion.button>
                    </form>
                </div>
