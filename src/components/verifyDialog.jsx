...
const EmailVerificationDialog = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Replace with your desired action after form submission.
        toast.success(`Code submitted: ${verificationCode}`);
    };
    ...
    return (
        <Dialog open={isverifyDialogOpen} >
            <DialogTrigger asChild>
                <button className="px-4 py-2 bg-indigo-600 text-white rounded-lg">Verify Email</button>
            </DialogTrigger>
